...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataoutput', required=True, type=str)
    ...
    df = fill_acceleration_na(df) #TODO: fix it to have an adaptable delta t
    ...
    output_csv_path = DATAOUTPUT / 'dataset.csv'
